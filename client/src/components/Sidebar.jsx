    ...
    >
      ...
      <div className="pb-5">
        <div className="flex justify-between items-center">
          ...
          {/* Three dots always visible; dropdown on hover */}
          <div className="relative group">
            ...
            />
            <div
              className="absolute top-full right-0 mt-2 w-32 p-5 rounded-md 
      ...
      <div className="bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5">
        ...
        <input
          ...
          className="bg-transparent border-none outline-none 
                     text-white text-xs placeholder-[#c6c8c8] flex-1"
      ...
      <div className = 'flex flex-col'>
        {userDummyData.map((user,index)=>(
          ...
          cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
            ...
            flex justify-center items-center rounded-full bg-voilet-500/50'>{index}</p>}
          </div>
