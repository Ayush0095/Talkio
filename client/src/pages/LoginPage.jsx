    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      flex-col gap-6 rounded-lg shadow-lg'>
        <h2 className='font-medium text-2xl flex justify-between items-center'>
          ...
          <button
          type='submit'
          className="w-full py-3 bg-gradient-to-r from-purple-400 to-violet-600 hover:from-purple-500 
          hover:to-violet-700 text-white rounded-md cursor-pointer transition-all duration-300">
