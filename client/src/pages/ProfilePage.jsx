...
const ProfilePage = () => {
  ...
  const [bio,setBio] = useState("Hello from QuickChat");
    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      rounded-g'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          className="p-2 border border-graay-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500"/>
          ...
          required
          rows={4}
          className="p-2 border border-graay-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500"></textarea>
